...
export function processMessage(msg) {
    ...
    switch (msg.type) {
      ...
      case "session_switched":
        ...
        // Existing sessions always render in their born mode. The
        // runtimeMode/runtimeTerminalId fields are reserved for future use;
        // today the server keeps them null and the client falls through to
        // msg.mode / msg.terminalId.
