...
function createProjectContext(opts) {
  ...
  function handleMessage(ws, msg) {
    ...
    // --- Task launcher (delegated to project-task-launcher.js) ---
    if (_taskLauncher.handleTaskLauncherMessage(ws, msg)) return;
  ...
  // --- Task launcher (delegated to project-task-launcher.js) ---
  var _taskLauncher = attachTaskLauncher({
    sm: sm,
    sdk: sdk,
    send: send,
    sendTo: sendTo,
    ...
    getDefaultVendor: function () {
      return sm ? (sm.defaultVendor || null) : null;
    },
  });
